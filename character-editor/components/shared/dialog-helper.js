...
export class DialogHelper {
    ...
    show(dialog, header, onCloseCallback) {
        ...
        this.#header.addEventListener("pointerdown", this.#headerOnMouseDown);
    ...
    #headerOnMouseDown = (event) => {
        ...
        UIKit.document.addEventListener("pointermove", this.#documentOnMouseMove);
        UIKit.document.addEventListener("pointerup", this.#documentOnMouseUp);
    }
    ...
    #documentOnMouseUp = (event) => {
        UIKit.document.removeEventListener("pointerup", this.#documentOnMouseUp);
        UIKit.document.removeEventListener("pointermove", this.#documentOnMouseMove);
    }

    #removeEventHandlers = () => {
        this.#dialog.removeEventListener("click", this.#dialogOnClick)
        UIKit.window.removeEventListener("resize", this.#windowOnResize);
        this.#header.removeEventListener("pointerdown", this.#headerOnMouseDown);
        UIKit.document.removeEventListener("pointerup", this.#documentOnMouseUp);
        UIKit.document.removeEventListener("pointermove", this.#documentOnMouseMove);
    }
}
