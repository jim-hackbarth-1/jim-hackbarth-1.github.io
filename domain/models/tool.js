    ...
    static async getTools(baseUrl) {
        ...
        if (!BuiltInTools.#tools) {
            ...
            BuiltInTools.#tools.push(new Tool({
                ...
                thumbnailSrc: '<g class="icon"><path d="M 50,10 L 35,20 45,20 45,45 20,45 20,35 10,50 20,65 20,55 45,55 45,80 35,80 50,90 65,80 55,80 55,55 80,55 80,65 90,50 80,35 80,45 55,45 55,20 65,20z"></path></g>',
                cursorSrc: '<g fill="white" stroke="black" stroke-width="4"><path d="M 50,10 L 35,20 45,20 45,45 20,45 20,35 10,50 20,65 20,55 45,55 45,80 35,80 50,90 65,80 55,80 55,55 80,55 80,65 90,50 80,35 80,45 55,45 55,20 65,20z"></path></g>',
            ...
            BuiltInTools.#tools.push(new Tool({
                ...
                thumbnailSrc: '<g class="icon"><path stroke-dasharray="4" d="M 35,35 l 60,0 0,60 -60,0 z" /><ellipse cx="35" cy="35" rx="25" ry="25" /><line x1="50" y1="50" x2="90" y2="90" /></g>',
                cursorSrc: '<g stroke="black" stroke-width="4" fill="none"><path stroke-dasharray="4" d="M 35,35 l 60,0 0,60 -60,0 z" /><ellipse cx="35" cy="35" rx="25" ry="25" /><line x1="50" y1="50" x2="90" y2="90" /></g>',
            ...
            BuiltInTools.#tools.push(new Tool({
                ...
                thumbnailSrc: '<g class="icon"><path stroke-dasharray="4" d="M 50,5 Q 15 5, 10 15 T 20 40 T 20 60 T 20 80 T 50 85 T 80 80 T 90 45 T 55 20 z" /><path d="M 15,15 L 65,65 A 2.5 2.5 -45 0 0 70 60 L 35,25 z" /></g>',
            ...
            BuiltInTools.#tools.push(new Tool({
                ...
                thumbnailSrc: '<g class="icon"><path d="M 10,50 l 0,40 80,0 0,-50" /><path stroke-dasharray="4" d="M 90,50 l -20,-40 -60,40" /><path d="M 10,50 m -4,-4 l 8,0 0,8 -8,0 z" /><path d="M 90,50 m -4,-4 l 8,0 0,8 -8,0 z" /><path d="M 70,10 m -4,-4 l 8,0 0,8 -8,0 z" /></g>',
                cursorSrc: selectCursorSrc,
                cursorHotspot: { x: 0, y: 0 },
                toolType: ToolType.EditingTool
            }));
            ...
            BuiltInTools.#tools.push(new Tool({
                ...
                thumbnailSrc: '<g class="icon"><path d="M 50,5 Q 15 5, 10 15 T 20 40 T 20 60 T 20 80 T 50 85 T 80 80 T 90 45 T 55 20 z" /><path stroke-dasharray="4" d="M 90,45 Q 55 45, 50 55 T 60 80 T 60 100 T 60 120 T 90 125 T 120 120 T 130 85 T 95 60 z" /><line stroke-width="4" x1="66" y1="45" x2="54" y2="63" /><line stroke-width="4" x1="74" y1="45" x2="54" y2="75" /><line stroke-width="4" x1="82" y1="45" x2="62" y2="75" /><line stroke-width="4" x1="90" y1="45" x2="70" y2="75" /><line stroke-width="4" x1="94" y1="51" x2="78" y2="75" /></g>',
                cursorSrc: selectCursorSrc,
                cursorHotspot: { x: 0, y: 0 },
                toolType: ToolType.EditingTool
            }));
            ...
            BuiltInTools.#tools.push(new Tool({
                ...
                thumbnailSrc: '<g class="icon-text"><path d="M 15,15 L 65,65 A 2.5 2.5 -45 0 0 70 60 L 35,25 z" /></g>',
            ...
            BuiltInTools.#tools.push(new Tool({
                ...
                thumbnailSrc: '<g class="icon"><path d="M 50,5 Q 15 5, 10 15 T 20 40 T 20 60 T 20 80 T 50 85 T 80 80 T 90 45 T 55 20 z" /><path class="icon-text" d="M 15,15 L 65,65 A 2.5 2.5 -45 0 0 70 60 L 35,25 z" /></g>',
                cursorSrc: drawCursorSrc,
                cursorHotspot: { x: 0, y: 0 },
                toolType: ToolType.DrawingTool
            }));
            ...
            BuiltInTools.#tools.push(new Tool({
                ...
                thumbnailSrc: '<g class="icon"><path d="M 15,15 l 40,0 0,50 -40,0 z" /><path class="icon-text" d="M 15,15 L 65,65 A 2.5 2.5 -45 0 0 70 60 L 35,25 z" /></g>',
                cursorSrc: '<g stroke="white" stroke-width="2" fill="black"><path d="M 70 10 l 20,0 0,20 -20,0 z" /><path d="M 5,5 L 80,80 A 5 5 -45 0 0 90 70 L 35,15 z" /></g>',
                cursorHotspot: { x: 0, y: 0 },
                toolType: ToolType.DrawingTool
            }));
            ...
            BuiltInTools.#tools.push(new Tool({
                ...
                thumbnailSrc: '<g class="icon"><path d="M 30 15 a 25 25 0 0 0 0 50 a 25 25 0 0 0 0 -50 z" /><path class="icon-text" d="M 15,20 L 65,70 A 2.5 2.5 -45 0 0 70 65 L 35,30 z" /></g>',
                cursorSrc: '<g stroke="white" stroke-width="4" fill="black"><path d="M 80 20 a 10 10 0 0 0 0 20 a 10 10 0 0 0 0 -20 z" /><path d="M 5,5 L 80,80 A 5 5 -45 0 0 90 70 L 35,15 z" /></g>',
                cursorHotspot: { x: 0, y: 0 },
                toolType: ToolType.DrawingTool
            }));
            ...
            BuiltInTools.#tools.push(new Tool({
                ...
                thumbnailSrc: '<g class="icon"><path height="50" width="50" d="M 30 15 a 25 25 0 0 0 0 50" /><path class="icon-text" d="M 15,20 L 65,70 A 2.5 2.5 -45 0 0 70 65 L 35,30 z" /></g>',
                cursorSrc: '<g><path stroke="black" stroke-width="2" fill="none" d="M 80 20 a 10 10 0 0 0 0 20" /><path stroke="white" stroke-width="2" fill="black" d="M 5,5 L 80,80 A 5 5 -45 0 0 90 70 L 35,15 z" /></g>',
                cursorHotspot: { x: 0, y: 0 },
                toolType: ToolType.DrawingTool
            }));
            ...
            BuiltInTools.#tools.push(new Tool({
                ...
                thumbnailSrc: '<g class="icon"><path  d="M 30,10 l 0,20 -20,20 20,20, 0,20 40,0 0,-20 a 20 20 0 0 0 0 -40 l 0,-20 -20,10 z" /><path class="icon-text" d="M 30,30 l 50,50 a 2.5 2.5 -45 0 0 5 -5 l -35,-35 z" /></g>',
                cursorSrc: drawCursorSrc,
                cursorHotspot: { x: 0, y: 0 },
                toolType: ToolType.DrawingTool
            }));
